...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  body::before {
    ...
    background: radial-gradient(circle, #f59e0b22 0%, #8b5cf614 35%, transparent 70%);
    filter: blur(40px);
    pointer-events: none;
  }
  body::after {
...
<body>
  <div class="wrap">
    ...
    <p>Your session expired for your security. Please refresh the page and try again.</p>
