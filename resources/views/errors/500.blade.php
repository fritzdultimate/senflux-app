...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  body::before {
    ...
    background: radial-gradient(circle, #ef444422 0%, #8b5cf614 35%, transparent 70%);
    filter: blur(40px);
    pointer-events: none;
  }
  body::after {
...
<body>
  <div class="wrap">
    ...
    <p>An unexpected error occurred on our end. We've been notified and we're on it.</p>
