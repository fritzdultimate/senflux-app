        ...
        <div class="sf-foot-grid" style="padding-bottom:3rem;width:100%;">
            ...
            <div class="sf-foot-brand" style="display:flex;flex-direction:column;gap:1rem;">
                ...
                <div style="display:flex;gap:.75rem;margin-top:.25rem;">
                    ...
                    @foreach([
                        ['X / Twitter', 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L2.25 2.25h6.988l4.26 5.632zm-1.161 17.52h1.833L7.084 4.126H5.117z', true, 'https://x.com/senflux_ai'],
                        ...
                        ['Instagram', 'M7.75 2C4.574 2 2 4.574 2 7.75v8.5C2 19.426 4.574 22 7.75 22h8.5C19.426 22 22 19.426 22 16.25v-8.5C22 4.574 19.426 2 16.25 2h-8.5zM12 7a5 5 0 1 1 0 10 5 5 0 0 1 0-10zm6-1.25a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0zM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6z', false, 'https://instagram.com/senflux_ai'],
            ...
            <div style="display:flex;flex-direction:column;gap:.65rem;">
                ...
                @foreach([['#','Terminal'],[route('market-insights'),'Market Insights'],[route('how-it-works'),'How It Works'],[route('why-solana'),'Why Solana']] as [$h,$l])
            ...
            <div style="display:flex;flex-direction:column;gap:.65rem;">
                ...
                @foreach([[route('about'),'About'],['#','Blog'],['#','Careers'],['#','Press Kit'],[route('contact'),'Contact']] as [$h,$l])
                    @if ($h === '#')
                        @continue
                    @endif
                    <a href="{{ $h }}" class="sf-foot-link">{{ $l }}</a>
            ...
            <div style="display:flex;flex-direction:column;gap:.65rem;">
                ...
                @foreach([[route('terms'),'Terms of Service'],[route('privacy'),'Privacy Policy'],[route('cookies'),'Cookie Policy'],[route('security'),'Security'],[route('disclosures'),'Disclosures']] as [$h,$l])
                    @if ($h === '#')
                        @continue
                    @endif
                    <a href="{{ $h }}" class="sf-foot-link">{{ $l }}</a>
