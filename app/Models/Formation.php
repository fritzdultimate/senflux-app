...
use App\Services\MarketData\FormationReasoningService;
...
class Formation extends Model {
    ...
    public function scoreReason(): string { return app(FormationReasoningService::class)->score($this); }
    public function confidenceReason(): string { return app(FormationReasoningService::class)->confidence($this); }
    public function metricReason(string $key): string { return app(FormationReasoningService::class)->metric($key, $this->{$key}, $this); }
